...
protected:
  ...
  {
    SmartPtr<typename ElementBuilder::type> elem = smart_cast<typename ElementBuilder::type>(this->linkerAssoc(el));
    if (elem) 
      return elem;
...
private:
  ...
  typedef std::unordered_map<String, BoxMLUpdateMethod, StringHash, StringEq> BoxMLBuilderMap;
