...
private:
  ...
  typedef std::unordered_map<String,SmartPtr<Fragment>,StringHash,StringEq> IdFragmentMap;
  IdFragmentMap idFragmentMap;

  typedef std::unordered_map<String,Handler,StringHash,StringEq> FunMap;
  FunMap funMap;
};
